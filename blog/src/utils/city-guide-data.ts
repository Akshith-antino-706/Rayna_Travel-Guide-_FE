...
export const CITY_GUIDE_DATA: Record<string, CityGuideData> = {
  dubai: {
    ...
    activities: {
      ...
      viewAllUrl: 'https://www.raynatours.com/dubai-activities',
      items: [
        { name: 'Burj Khalifa', description: "World's tallest building at 828m", price: 'From AED 179', image: 'https://images.unsplash.com/photo-1582672060674-bc2bd808a8b5?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/dubai-activities' },
        { name: 'Desert Safari', description: 'Dune bashing, BBQ & entertainment', price: 'From AED 120', image: 'https://images.unsplash.com/photo-1509233725247-49e657c54213?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/dubai-activities' },
        { name: 'Dubai Frame', description: '150m picture frame structure', price: 'From AED 50', image: 'https://images.unsplash.com/photo-1580674684081-7617fbf3d745?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/dubai-activities' },
        { name: 'Balloon Flights', description: 'Sunrise views over the desert', price: 'From AED 950', image: 'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/dubai-activities' },
      ],
    },
    spots: {
      label: 'Beaches',
  ...
  'abu-dhabi': {
    ...
    activities: {
      ...
      viewAllUrl: 'https://www.raynatours.com/abu-dhabi-activities',
      items: [
        { name: 'Sheikh Zayed Mosque', description: 'One of the world\'s largest mosques, stunning white marble architecture', price: 'Free Entry', image: 'https://images.unsplash.com/photo-1585320806297-9794b3e4eeae?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/abu-dhabi-activities' },
        { name: 'Ferrari World', description: 'Home to Formula Rossa, the world\'s fastest roller coaster', price: 'From AED 295', image: 'https://images.unsplash.com/photo-1558981359-219d6364c9c8?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/abu-dhabi-activities' },
        { name: 'Louvre Abu Dhabi', description: 'Universal museum showcasing art from across civilizations', price: 'From AED 63', image: 'https://images.unsplash.com/photo-1582555172866-f73bb12a2ab3?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/abu-dhabi-activities' },
        { name: 'Desert Safari', description: 'Dune bashing, camel rides & traditional Bedouin dinner', price: 'From AED 150', image: 'https://images.unsplash.com/photo-1509233725247-49e657c54213?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/abu-dhabi-activities' },
      ],
    },
    spots: {
      label: 'Beaches',
  ...
  bangkok: {
    ...
    activities: {
      ...
      viewAllUrl: 'https://www.raynatours.com/bangkok-activities',
      items: [
        { name: 'Grand Palace & Wat Phra Kaew', description: 'Thailand\'s most sacred site and former royal residence', price: 'From THB 500', image: 'https://images.unsplash.com/photo-1563492065599-3520f775eeed?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/bangkok-activities' },
        { name: 'Floating Market Tour', description: 'Damnoen Saduak or Amphawa by traditional longtail boat', price: 'From THB 800', image: 'https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/bangkok-activities' },
        { name: 'Chao Phraya Dinner Cruise', description: 'Romantic evening cruise with buffet dinner and city views', price: 'From THB 1200', image: 'https://images.unsplash.com/photo-1562602833-0f4ab2fc46e5?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/bangkok-activities' },
        { name: 'Muay Thai Evening Show', description: 'Live Thai boxing at Rajadamnern or Lumpinee stadium', price: 'From THB 1500', image: 'https://images.unsplash.com/photo-1555597673-b21d5c935865?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/bangkok-activities' },
      ],
    },
    spots: {
      label: 'Landmarks',
  ...
  singapore: {
    ...
    activities: {
      ...
      viewAllUrl: 'https://www.raynatours.com/singapore-activities',
      items: [
        { name: 'Marina Bay Sands SkyPark', description: 'Iconic infinity pool and observation deck 57 floors up', price: 'From SGD 26', image: 'https://images.unsplash.com/photo-1525625293386-3f8f99389edd?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/singapore-activities' },
        { name: 'Gardens by the Bay', description: 'Futuristic Supertrees and OCBC Skyway light show', price: 'From SGD 28', image: 'https://images.unsplash.com/photo-1565967511849-76a60a516170?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/singapore-activities' },
        { name: 'Universal Studios', description: 'Southeast Asia\'s only Universal Studios theme park on Sentosa', price: 'From SGD 83', image: 'https://images.unsplash.com/photo-1541877590-a1c5db3394c6?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/singapore-activities' },
        { name: 'Singapore Night Safari', description: 'World\'s first nocturnal wildlife park with tram rides', price: 'From SGD 49', image: 'https://images.unsplash.com/photo-1474511320723-9a56873867b5?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/singapore-activities' },
      ],
    },
    spots: {
      label: 'Beaches',
  ...
  tokyo: {
    ...
    activities: {
      ...
      viewAllUrl: 'https://www.raynatours.com/tokyo-activities',
      items: [
        { name: 'Senso-ji Temple', description: 'Tokyo\'s oldest and most visited Buddhist temple in Asakusa', price: 'Free Entry', image: 'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/tokyo-activities' },
        { name: 'TeamLab Borderless', description: 'Immersive digital art museum — a truly unique experience', price: 'From JPY 3200', image: 'https://images.unsplash.com/photo-1531512073830-ba890ca4eba2?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/tokyo-activities' },
        { name: 'Mt Fuji Day Trip', description: 'Iconic volcano visit with Hakone or Kawaguchiko lakes', price: 'From JPY 8000', image: 'https://images.unsplash.com/photo-1492571350019-22de08371fd3?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/tokyo-activities' },
        { name: 'Shibuya Crossing & Sky', description: 'World\'s busiest crossing + Shibuya Sky rooftop observation deck', price: 'From JPY 2000', image: 'https://images.unsplash.com/photo-1542051841857-5f90071e7989?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/tokyo-activities' },
      ],
    },
    spots: {
      label: 'Parks & Gardens',
  ...
  london: {
    ...
    activities: {
      ...
      viewAllUrl: 'https://www.raynatours.com/london-activities',
      items: [
        { name: 'Tower of London', description: 'Crown Jewels, Beefeaters & 900 years of royal history', price: 'From GBP 34', image: 'https://images.unsplash.com/photo-1529655683826-aba9b3e77383?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/london-activities' },
        { name: 'British Museum', description: 'World\'s greatest collection of human history & culture', price: 'Free Entry', image: 'https://images.unsplash.com/photo-1565060169194-19fabf63012c?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/london-activities' },
        { name: 'London Eye', description: 'Giant Ferris wheel with panoramic views across the Thames', price: 'From GBP 28', image: 'https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/london-activities' },
        { name: 'Thames River Cruise', description: 'Scenic 1-hour cruise from Westminster to Tower Bridge', price: 'From GBP 15', image: 'https://images.unsplash.com/photo-1526129318478-62ed807ebdf9?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/london-activities' },
      ],
    },
    spots: {
      label: 'Parks',
  ...
  paris: {
    ...
    activities: {
      ...
      viewAllUrl: 'https://www.raynatours.com/paris-activities',
      items: [
        { name: 'Eiffel Tower', description: 'The iron lady — summit tickets & champagne bar', price: 'From EUR 29', image: 'https://images.unsplash.com/photo-1499856871958-5b9627545d1a?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/paris-activities' },
        { name: 'Louvre Museum', description: 'Mona Lisa, Venus de Milo & 35,000 works of art', price: 'From EUR 22', image: 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/paris-activities' },
        { name: 'Seine River Cruise', description: '1-hour Bateaux Mouches cruise past Notre-Dame & bridges', price: 'From EUR 17', image: 'https://images.unsplash.com/photo-1549144511-f099e773c147?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/paris-activities' },
        { name: 'Palace of Versailles', description: 'Louis XIV\'s lavish palace & 800 hectares of gardens', price: 'From EUR 21', image: 'https://images.unsplash.com/photo-1565106430482-8f6e74349ca1?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/paris-activities' },
      ],
    },
    spots: {
      label: 'Neighborhoods',
  ...
  rome: {
    ...
    activities: {
      ...
      viewAllUrl: 'https://www.raynatours.com/rome-activities',
      items: [
        { name: 'Colosseum & Roman Forum', description: 'Walk where gladiators fought — skip-the-line guided tour', price: 'From EUR 29', image: 'https://images.unsplash.com/photo-1552832230-c0197dd311b5?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/rome-activities' },
        { name: 'Vatican Museums & Sistine Chapel', description: 'Michelangelo\'s masterpiece ceiling & St Peter\'s Basilica', price: 'From EUR 34', image: 'https://images.unsplash.com/photo-1515542622106-78bda8ba0e5b?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/rome-activities' },
        { name: 'Borghese Gallery', description: 'World\'s finest Bernini sculptures in a stunning villa', price: 'From EUR 20', image: 'https://images.unsplash.com/photo-1541963463532-d68292c34b19?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/rome-activities' },
        { name: 'Rome by Night Tour', description: 'Trevi Fountain, Pantheon & piazzas after dark', price: 'From EUR 35', image: 'https://images.unsplash.com/photo-1529154691717-3306083d869e?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/rome-activities' },
      ],
    },
    spots: {
  ...
  istanbul: {
    ...
    activities: {
      ...
      viewAllUrl: 'https://www.raynatours.com/istanbul-activities',
      items: [
        { name: 'Hagia Sophia & Blue Mosque', description: 'Two of the world\'s greatest religious monuments side by side', price: 'Free Entry', image: 'https://images.unsplash.com/photo-1541432901042-2d8bd64b4a9b?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/istanbul-activities' },
        { name: 'Bosphorus Cruise', description: 'Scenic strait separating Europe and Asia — stunning palaces', price: 'From TRY 400', image: 'https://images.unsplash.com/photo-1524231757912-21f4fe3a7200?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/istanbul-activities' },
        { name: 'Topkapi Palace', description: 'Ottoman imperial palace with harem, treasury & Bosphorus views', price: 'From TRY 750', image: 'https://images.unsplash.com/photo-1558618047-3e84d7c5ba02?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/istanbul-activities' },
        { name: 'Grand Bazaar & Spice Market', description: 'The world\'s oldest covered market with 4,000 shops', price: 'Free Entry', image: 'https://images.unsplash.com/photo-1555529902-5261145633bf?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/istanbul-activities' },
      ],
    },
    spots: {
      label: 'Districts',
  ...
  'new-york': {
    ...
    activities: {
      ...
      viewAllUrl: 'https://www.raynatours.com/new-york-activities',
      items: [
        { name: 'Statue of Liberty & Ellis Island', description: 'America\'s most iconic monument via ferry from Battery Park', price: 'From USD 24', image: 'https://images.unsplash.com/photo-1534430480872-3498386e7856?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/new-york-activities' },
        { name: 'Empire State Building', description: '102-floor Art Deco skyscraper with iconic NYC views', price: 'From USD 44', image: 'https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/new-york-activities' },
        { name: 'Central Park Bike Tour', description: '843-acre urban park by guided bike or on your own', price: 'From USD 35', image: 'https://images.unsplash.com/photo-1568515387631-8b650bbcdb90?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/new-york-activities' },
        { name: 'Broadway Show', description: 'Best live theatre in the world — Times Square is electric', price: 'From USD 79', image: 'https://images.unsplash.com/photo-1532665767784-7e18a22e3c5e?w=400&h=300&fit=crop&q=80', url: 'https://www.raynatours.com/new-york-activities' },
      ],
    },
    spots: {
      label: 'Neighborhoods',
